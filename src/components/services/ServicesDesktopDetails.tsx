...
export function ServicesDesktopDetails() {
  ...
  return (
    <main className="services-desktop-details relative overflow-hidden border-t border-white/[0.07] bg-[#07080c] pb-32 pt-32 text-white">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-[-12rem] top-12 h-[36rem] w-[36rem] rounded-full bg-[#7c5cff]/12 blur-[160px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-[-12rem] top-[48rem] h-[34rem] w-[34rem] rounded-full bg-[#29d6ff]/9 blur-[150px]"
      />
