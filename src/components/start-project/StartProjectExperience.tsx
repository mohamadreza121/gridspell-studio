        ...
        <div className="grid gap-px bg-white/[0.07] sm:grid-rows-[.82fr_1.18fr]">
          <div className="bg-[#10141c] p-5 sm:p-6">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="grid h-11 w-11 place-items-center border border-[#8be9ff]/16 bg-[#8be9ff]/7 text-[#8be9ff]">
...
function ProjectRoutePanel() {
  return (
    <section id="project-route" className={styles.routePanel} aria-labelledby="project-route-title">
      ...
      <div className={styles.routeSteps}>
        {nextSteps.map(({ icon: Icon, title, text }, index) => (
          <article key={title} className={styles.routeStep}>
            <div className={styles.routeStepTopline}>
              <span className="font-mono text-[0.5rem] uppercase tracking-[0.18em] text-white/28">
                Step 0{index + 1}
              </span>
              <Icon className="h-5 w-5 text-[#8be9ff]" />
            </div>
            <h3 className="mt-8 max-w-[13ch] font-display text-2xl font-semibold leading-[0.95] tracking-[-0.045em] text-white/82 sm:text-3xl">
              {title}
            </h3>
            <p className="mt-5 max-w-sm text-sm leading-7 text-white/40">{text}</p>
          </article>
        ))}
      </div>

      <div className={styles.routeDetails}>
        <div className={styles.strongInquiry}>
          <div className="flex items-center gap-3">
            <ShieldCheck className="h-5 w-5 text-[#8be9ff]" />
            <h3 className="text-[0.58rem] font-black uppercase tracking-[0.2em] text-white/48">
        ...
        <div className={styles.routeOutcomes}>
          <div className={styles.outcomeCard}>
            <CircleDollarSign className="h-5 w-5 text-[#8be9ff]" />
            <p className="mt-6 text-[0.5rem] uppercase tracking-[0.18em] text-white/28">Pricing</p>
            <p className="mt-3 text-sm font-semibold leading-6 text-white/62">
              Payment plans for approved projects
            </p>
          </div>
          <div className={styles.outcomeCard}>
            <Gauge className="h-5 w-5 text-[#8be9ff]" />
            <p className="mt-6 text-[0.5rem] uppercase tracking-[0.18em] text-white/28">
              Reply quality
            </p>
            <p className="mt-3 text-sm font-semibold leading-6 text-white/62">
              Specific context, not an automatic quote
            </p>
          </div>
        </div>
      </div>
        ...
        <Container className="relative">
          <div className="grid gap-8 border-b border-white/[0.08] pb-10 xl:grid-cols-[.8fr_1.2fr] xl:items-end">
            ...
            <p className="max-w-3xl text-base leading-8 text-white/44 sm:text-lg sm:leading-9 xl:justify-self-end">
              The questions are grouped by contact, scope, services, and business context. Existing pricing, demo, or Experience Lab selections stay attached automatically.
            </p>
          </div>
