...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "A warm, premium beauty booking landing page with cinematic studio video, interactive treatments, artist credibility, guest reviews, and a polished appointment flow.",
  path: "/demo/beauty-booking"
});

export default function BeautyBookingDemoPage() {
  return <BeautyBookingExperience />;
}
